    ...
    <div className="p-3 md:p-8 overflow-auto flex-1 flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 md:gap-0 mb-4 md:mb-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="bg-yellow-600 text-white px-4 md:px-6 py-2 rounded-md hover:bg-yellow-700 flex items-center gap-2 text-sm md:text-base whitespace-nowrap"
          >
            <span>+</span>
      ...
      <div className="mb-4 md:mb-6 flex flex-col sm:flex-row justify-end">
        <input
          ...
          className="px-3 md:px-4 py-2 border border-gray-400 rounded-md w-full sm:w-64 text-sm md:text-base"
        />
      </div>
